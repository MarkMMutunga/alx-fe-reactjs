  ...
  useEffect(() => {
    ...
    const loadRecipes = async () => {
      try {
        ...
        // Fallback: load data directly (since fetch might not work with local files in dev)
          ...
          {recipes.map((recipe) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* Action Button */}
                <button className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                  View Recipe
                </button>
              </div>
            </div>
